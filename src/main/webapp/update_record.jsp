...
%>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="fname" name="fname" value="<%= rs.getString("fname")%>">
  </div>
  <div class="mb-3">
    <label for="phone" class="form-label">Phone</label>
    <input type="text" class="form-control" id="phone" name="phone" value="<%= rs.getString("phone")%>">
  </div>
  <div class="mb-3">
